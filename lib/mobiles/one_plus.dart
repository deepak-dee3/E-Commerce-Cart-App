...
class one_plus_page extends StatelessWidget{
  ...
  final List<Map<String,dynamic>> inner_items = [

    {
      "title" : "One Plus 12",
      "price" : " 100000",
      "images" : "https://th.bing.com/th/id/OIP.DqXyvmOkhAmgGvJsRc5BggHaHa?w=168&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7",
    },

    {
      "title" : "One Plus 11R",
      "price" : " 100000",
      "images" : "https://th.bing.com/th/id/OIP.-o6PyI1fvmcrMVYJj5U7OwHaHa?w=162&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7",
    },
    ...
    resizeToAvoidBottomInset: false,
     ...
     body:Column(children:[
      ...
      child:Row(children: [
        ...
        //IconButton(onPressed: (){ Navigator.push(context, MaterialPageRoute(builder: (context) => apple())); }, icon: Icon(Icons.arrow_left,size: 40,),highlightColor: Colors.grey,),
        Padding(padding:EdgeInsets.only(left:125),child: Text('ONE PLUS',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20)),),
       // Padding(padding: EdgeInsets.only(left:55),child:IconButton(highlightColor: Colors.black,onPressed: (){}, icon: Icon(Icons.arrow_right,size: 40,)),),
      ...
      return Container(
        ...
        child:Column(children: [
          ...
          ClipRRect(
            ...
            child: Image.network('${inner_items.elementAt(index)['images']}',scale: 1.0,),
